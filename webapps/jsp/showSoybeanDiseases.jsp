	...
	<div id="wrapper">
			...
			<ul class="nav navbar-top-links navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-user">
						<li><a href="farmersProfile?farmerId=${farmerId}"><i class="fa fa-user fa-fw"></i>User
								Profile</a></li>
						<li class="divider"></li>
		...
		<div id="page-wrapper">
			<div class="row">
				<!-- Page Header -->
				<div class="col-lg-12">
					<h1 class="page-header">Soybean</h1>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="panel panel-default col-lg-12">
					<div class="panel-heading">
						<h3 class="panel-title">List of Soybean Diseases</h3>
					</div>
					<div class="panel-body">
						...
						<% count=0; %>
							<table class="table table-bordered">
								...
								<c:if test="${empty soybeanDisease}">
									<tr>
										<td colspan="4"><font style="color: red;">No
												Disease Found</font></td>
									</tr>
								</c:if>
								<c:if test="${! empty soybeanDisease}">
									<c:forEach var="soybean" items="${soybeanDisease}">
										<tr>
											<td><%=++count%></td>
											<td><c:out value="${soybean.diseaseName}"></c:out></td>
											<td><c:out value="${soybean.culturalControl}"></c:out></td>
											<td><c:out value="${soybean.chemicalControl}"></c:out></td>
											<td><c:out value="${soybean.biologicalControl}"></c:out></td>
											
											<td>&nbsp;<a class="btn btn-success"
												href="updateSoybeanDisease?diseaseId=${soybean.diseaseId}"><i
													class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
												&nbsp;&nbsp;
											</td>
											<td><a class="btn btn-danger"
												href="javascript:deleteSoybean('deleteSoybeanDisease?diseaseId=${soybean.diseaseId}');"><span
