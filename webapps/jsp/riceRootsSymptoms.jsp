				...
				<div class="panel panel-info col-lg-9 col-lg-offset-1">
					...
					<div class="panel-body">
						<div
							...
							<form:form action="riceRootDiag" method="post"
								commandName="riceRootsSymptoms">
								...
								<table class="table table-bordered table-hover">
									...
									<tr>
										<td style="font-size: 16px;">Growth of infected plants
											slows as compared to healthy plants.</td>
									...
									<tr>
										<td style="font-size: 16px;">Roots appear dark brown or
											black</td>
										<td><input type="checkbox" class="form-control"
											name="darkRoots" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Roots are limp and not
											brittle</td>
										<td><input type="checkbox" class="form-control"
											name="limpRoots" value="yes" /></td>
									</tr>
									<tr>
