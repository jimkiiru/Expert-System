			...
			<div class="row">
				...
				<div class="panel panel-default col-lg-12">
					<div class="panel-heading">
						<h3 class="panel-title">List of Maize Diseases</h3>
					</div>
					<div class="panel-body">
						...
						<% count=0; %>
							<table class="table table-bordered">
								...
								<c:if test="${! empty maizeDisease}">
									<c:forEach var="maize" items="${maizeDisease}">
										<tr>										
											<td><%=++count%></td>
											<td><c:out value="${maize.diseaseName}"></c:out></td>
											<td><c:out value="${maize.culturalControl}"></c:out></td>
											<td><c:out value="${maize.chemicalControl}"></c:out></td>
											<td><c:out value="${maize.biologicalControl}"></c:out></td>
											
											<td>&nbsp;<a class="btn btn-success"
												href="updateMaizeDisease?diseaseId=${maize.diseaseId}"><i
													class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
												&nbsp;&nbsp;
											</td>
											<td><a class="btn btn-danger"
												href="javascript:deleteMaize('deleteMaizeDisease?diseaseId=${maize.diseaseId}');"><span
