				...
				<div class="panel panel-info col-lg-9 col-lg-offset-1">
					...
					<div class="panel-body">
						<div
							...
							<form:form action="riceStemDiag" method="post"
								commandName="riceStemSymptoms">
								...
								<table class="table table-bordered table-hover">
									...
									<tr>
										<td style="font-size: 16px;">Black, rectangular lesions
											with distinct angular borders on the leaf sheath</td>
										<td><input type="checkbox" class="form-control"
											value="yes" name="rectangularLesions" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Infected sheaths die and
											slough off</td>
										<td><input type="checkbox" class="form-control"
											value="yes" name="sheathDie" /></td>
									</tr>
