				...
				<div class="panel panel-info col-lg-9 col-lg-offset-1">
					...
					<div class="panel-body">
						<div
							...
							<form:form action="maizeRootDiag" method="post"
								commandName="maizeRootSymptoms">
								...
								<table class="table table-bordered table-hover">
									...
									<tr>
										<td style="font-size: 16px;">Slow growth of the infected
											plant.</td>
										<td><input type="checkbox" class="form-control"
											value="yes" name="slowGrowth" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Older leaves yellow and fall</td>
										<td><input type="checkbox" class="form-control"
											name="yellowLeaves" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Margins of leaves die</td>
										<td><input type="checkbox" class="form-control"
											name="leavesDie" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Brownish lesions on the
											roots</td>
										<td><input type="checkbox" class="form-control"
											name="brownishLesions" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Yellowed or bleached leaf
											streaks</td>
										<td><input type="checkbox" class="form-control"
											name="bleachedLeaf" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Internal vascular
											discoloration</td>
										<td><input type="checkbox" class="form-control"
											name="vascularDiscoloration" value="yes" /></td>
									</tr>

									<tr>
										<td style="font-size: 16px;">Nutrient deficiency</td>
										<td><input type="checkbox" class="form-control"
											name="nutrientDeficiency" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Wilting</td>
										<td><input type="checkbox" class="form-control"
											name="wilting" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Short root systems</td>
										<td><input type="checkbox" class="form-control"
											name="shortRoots" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Short, stubby root</td>
										<td><input type="checkbox" class="form-control"
											name="stubbyRoots" value="yes" /></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">Dark lesions on roots</td>
										<td><input type="checkbox" class="form-control"
											name="darkLessions" value="yes" /></td>
									</tr>
