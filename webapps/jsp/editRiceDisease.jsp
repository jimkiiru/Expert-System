		...
		<div id="page-wrapper">
			...
			<div class="panel panel-info col-lg-9 col-lg-offset-2">
				<div class="panel-heading">
					<h3 class="panel-title col-lg-offset-3">Edit Rice Diseases</h3>
				</div>

				<form:form action="updateRiceDisease" method="post"
					commandName="editRiceDisease" enctype="multipart/form-data">
					<div class="row">
