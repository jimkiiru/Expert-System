				...
				<div class="panel panel-info col-lg-9 col-lg-offset-1">
					...
					<div class="panel-body">
						<div
							...
							<form:form action="soybeanSeedDiag" method="post"
								commandName="soybeanSeedSymptoms">
								...
								<table class="table table-bordered table-hover">
									...
									<tr>
										<td style="font-size: 16px;">Pre- and post -emergence
											damping off</td>
										<td><input type="checkbox" class="form-control"
											value="yes" name="dampingOff" /></td>
									</tr>
									...
									<tr>
										<td style="font-size: 16px;">Soft, brownish-colored,
											rotting tissue.</td>
										<td><input type="checkbox" class="form-control"
											name="rottingTissue" value="yes" /></td>
									</tr>

									<tr>
										<td style="font-size: 16px;">Seedlings have a
											reddish-brown sunken lesion</td>
										<td><input type="checkbox" class="form-control"
											name="sunkenLesion" value="yes" /></td>
									</tr>
