	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<h3 style="color:red;text-align:center;">Select the affected part*</h3>
				<center>
					<a href="riceleaf" class="list-group-item btn-info"><font
						style="font-size: 16px; font-weight: bold; color: #fff;">LEAVES</font></a>
				</center>
				<center>
					<a href="ricegrain" class="list-group-item btn-info"><font
						style="font-size: 16px; font-weight: bold; color: #fff;">GRAIN</font></a>
				</center>
				<center>
					<a href="ricestem" class="list-group-item btn-info"><font
						style="font-size: 16px; font-weight: bold; color: #fff;">STEM</font></a>
				</center>
				<center>
					<a href="riceroot" class="list-group-item btn-info"><font
						style="font-size: 16px; font-weight: bold; color: #fff;">ROOTS</font></a>
				</center>
				<center>
					<a href="riceneck" class="list-group-item btn-info"><font
						style="font-size: 16px; font-weight: bold; color: #fff;">NECK</font></a>
				</center>
			</div>
		</div>
	</div>
