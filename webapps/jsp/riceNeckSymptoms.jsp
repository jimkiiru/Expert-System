				...
				<div class="panel panel-info col-lg-9 col-lg-offset-1">
					...
					<div class="panel-body">
						<div
							...
							<form:form action="riceNeckDiag" method="post"
								commandName="riceNeckSymptoms">
								...
								<table class="table table-bordered table-hover">
									...
									<tr>
										<td style="font-size: 16px;">Neck region of panicle has a
											black color</td>
										<td><input type="checkbox" class="form-control"
											value="yes" name="blackColor" /></td>
									</tr>
									<tr>

										<td style="font-size: 16px;">Panicle breaks at the neck
											and hangs</td>
										<td><input type="checkbox" class="form-control"
											name="neckBreaks" value="yes" /></td>
