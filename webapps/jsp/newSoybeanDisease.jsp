			...
			<div class="row">
				...
				<div class="panel panel-info col-lg-12">
					<div class="panel-heading">
						<h3 class="panel-title col-lg-offset-3">Potato Disease
							Registration Form</h3>
					</div>
					<h3 style="color: red;">${successMess}</h3>
					<form:form action="saveSoybeanDisease" method="post"
						commandName="newSoybeanDisease" enctype="multipart/form-data">
						<div class="row">
							...
							<div class="form-group col-md-6">
								<div class="col-md-8">
									...
									<textarea cols="25" rows="5" class="form-control"
										name="culturalControl" id="cultural"></textarea>
