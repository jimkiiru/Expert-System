			...
			<div class="row">
				...
				<div class="panel panel-default col-lg-12">
					<div class="panel-heading">
						<h3 class="panel-title">List of Rice Diseases</h3>
					</div>
					<div class="panel-body">
						...
						<% count=0; %>
							<table class="table table-bordered">							
								...
								<c:if test="${! empty riceDisease}">
									<c:forEach var="rice" items="${riceDisease}">
									
										<tr>										
										 	<td><%=++count%></td>
											<td><c:out value="${rice.diseaseName}"></c:out></td>
											<td><c:out value="${rice.culturalControl}"></c:out></td>
											<td><c:out value="${rice.chemicalControl}"></c:out></td>
											<td><c:out value="${rice.biologicalControl}"></c:out></td>
											
											<td>&nbsp;<a class="btn btn-success"
												href="updateRiceDisease?diseaseId=${rice.diseaseId}"><i
													class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
												&nbsp;&nbsp;
											</td>
											<td><a class="btn btn-danger"
												href="javascript:deleteRice('deleteRiceDisease?diseaseId=${rice.diseaseId}');"><span
