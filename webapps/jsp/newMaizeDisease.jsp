			...
			<div class="row">
				...
				<div class="panel panel-info col-lg-12">
					<div class="panel-heading">
						<h3 class="panel-title col-lg-offset-3">Maize Disease
							Registration Form</h3>
					</div>
					<h3 style="color: red;">${successMess}</h3>
					<form:form action="saveMaizeDisease" method="post"
						commandName="newMaizeDisease" enctype="multipart/form-data">
						<div class="row">
							<div class="form-group col-md-6">
								<div class="col-md-8">
									<label for="SurName">Name Of The Disease<font
										style="color: red">*</font></label> <input class="form-control"
										name="diseaseName" placeholder="diseaseName" />
							...
							<div class="form-group col-md-6">
								<div class="col-md-8">
									<label for="Reports">Upload Photo<font
										...
										class="form-control btn-primary" path="diseasePhoto"
										name="fileUpload" type="file" required />
							...
							<div class="form-group col-md-6">
								<div class="col-md-8">
									<label for="cultural Control">Cultural Control</label>
									<textarea cols="25" rows="5" class="form-control"
										name="culturalControl" id="culturalControl"></textarea>
								</div>
							</div>
							...
							<div class="form-group col-md-6">
								<div class="col-md-8">
									...
									<textarea cols="25" rows="5" class="form-control"
										name="chemicalControl" id="chemical"></textarea>
								</div>
							</div>
							...
							<div class="form-group col-md-6">
								<div class="col-md-8">
									...
									<textarea cols="25" rows="5" class="form-control"
										name="biologicalControl" id="biological"></textarea>
								</div>
							</div>
