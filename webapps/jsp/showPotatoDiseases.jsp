	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<!-- Page Header -->
				<div class="col-lg-12">
					<h1 class="page-header">Potato</h1>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="panel panel-default col-lg-12">
					<div class="panel-heading">
						<h3 class="panel-title">List of Potato Diseases</h3>
					</div>
					<div class="panel-body">
						...
						<% count=0; %>
							<table class="table table-bordered">
								...
								<c:if test="${! empty potatoDisease}">
									<c:forEach var="potato" items="${potatoDisease}">
										<tr>
											<td><%=++count%></td>
											<td><c:out value="${potato.diseaseName}"></c:out></td>
											<td><c:out value="${potato.culturalControl}"></c:out></td>
											<td><c:out value="${potato.chemicalControl}"></c:out></td>
											<td><c:out value="${potato.biologicalControl}"></c:out></td>
											
											<td>&nbsp;<a class="btn btn-success"
												href="updatePotatoDisease?diseaseId=${potato.diseaseId}"><i
													class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
												&nbsp;&nbsp;
											</td>
											<td><a class="btn btn-danger"
												href="javascript:deletePotato('deletePotatoDisease?diseaseId=${potato.diseaseId}');"><span
