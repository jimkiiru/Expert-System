			...
			<div class="row">
				...
				<div class="panel panel-default col-lg-12">
					<div class="panel-heading">
						<h3 class="panel-title">List of Registered Farmers</h3>
					</div>
					<div class="panel-body">
						...
						<% count=0; %>
							<table class="table table-bordered">
								...
								<c:if test="${! empty farmer}">
									<c:forEach var="farm" items="${farmer}">
										<tr>
											<td><c:out value="${farm.surname}"></c:out></td>
											<td><c:out value="${farm.fname}"></c:out></td>
											<td><c:out value="${farm.emailaddress}"></c:out></td>
											<td><c:out value="${farm.phonenum}"></c:out></td>
											<td><c:out value="${farm.occupation}"></c:out></td>
											<td><c:out value="${farm.county}"></c:out></td>
											<td><c:out value="${farm.nationalId}"></c:out></td>
										</tr>
									</c:forEach>
								</c:if>
							</table>
