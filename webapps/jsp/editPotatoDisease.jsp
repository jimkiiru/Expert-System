			...
			<div class="row">
				...
				<div class="panel panel-info col-lg-9 col-lg-offset-2">
					<div class="panel-heading">
						<h3 class="panel-title col-lg-offset-3">Edit Potato Diseases</h3>
					</div>

					<form:form action="updatePotatoDisease" method="post"
						commandName="editPotatoDisease" enctype="multipart/form-data">
						<div class="row">
